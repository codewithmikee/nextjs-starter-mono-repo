...
type QueryBasedPaginationProps = {
  ...
  totalFetchedRecords: number; // Total records from the latest fetch
};
...
function QueryBasedPagination({
  ...
  const totalFrontendPages = Math.ceil(
    totalFetchedRecords / pagination.pageSize
  );
  ...
  const generatePaginationNumbers = () => {
    ...
    if (totalFrontendPages <= maxVisiblePages) {
      ...
      if (frontendPage > 3) pageNumbers.push(1, '...');
    ...
    <Pagination>
      <PaginationContent>
        ...
        >
          <PaginationPrevious
            onClick={handlePrev}
            isActive={backendPagination.hasPrevPage}
          />
        </PaginationItem>
        ...
        <PaginationItem>
          <PaginationNext
            ...
            onClick={handleNext}
            isActive={backendPagination.hasNextPage}
          />
        </PaginationItem>
      </PaginationContent>
    </Pagination>
