...
export function PageSkeleton() {
    return (<div className='flex h-full w-full flex-col space-y-3'>
      ...
      <div className='mt-8 grid h-full w-full grid-cols-1 gap-4 md:grid-cols-2'>
        {[...Array(2)].map((_, i) => (<div key={i} className='flex h-full w-full flex-col space-y-3 rounded-lg border p-4'>
...
export function CardSkeleton() {
    return (<div className='flex flex-col space-y-3 rounded-lg border p-4'>
