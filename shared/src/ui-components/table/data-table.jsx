...
export function DataTable({ columns, data, totalItems, pageSizeOptions = [10, 20, 30, 40, 50] }) {
    const [currentPage, setCurrentPage] = useQueryState('page', parseAsInteger.withOptions({ shallow: false }).withDefault(1));
    const [pageSize, setPageSize] = useQueryState('limit', parseAsInteger
        ...
        <div className='flex w-full items-center justify-between'>
          ...
          <div className='flex flex-col items-center gap-4 sm:flex-row sm:gap-6 lg:gap-8'>
            <div className='flex items-center space-x-2'>
              ...
              <Select value={`${paginationState.pageSize}`} onValueChange={(value) => {
