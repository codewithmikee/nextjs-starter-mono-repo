...
import { SheetHeader, SheetTitle, SheetDescription, SheetContent, Sheet } from '@/ui-components/ui/sheet';
    ...
    return (<SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div style={{
            ...
            ...style
        }} className={cn('group/sidebar-wrapper flex min-h-svh w-full text-sidebar-foreground has-[[data-variant=inset]]:bg-sidebar', className)} ref={ref} {...props}>
            {children}
          </div>
        </TooltipProvider>
